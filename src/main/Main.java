...
import objetos.IndividuoReinas;
import objetos.IndividuoTSP;
import objetos.Matriz;
import tsp.TSPGenetico;
...
public class Main {
    ...
    public static void main(String[] args) throws IOException {
        int[] a = {3,1,2,3,4,5,6,4};
        IndividuoReinas ir = new IndividuoReinas(a);
        ...
        IndividuoTSP aux = new IndividuoTSP(new int[]{3,1,2,0});
